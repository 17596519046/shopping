                        ...
                        <div class="item-single  item-item " product="1" id="product_57730305717" num="1" jdbx=""
                            ...
                            <div class="item-form">
                                ...
                                <div class="cell p-goods">
                                    <div class="goods-item">
                                        <div class="p-img">
                                            <a href="//item.jd.com/57730305717.html" target="_blank"
                                               class="J_zyyhq_57730305717" pnc="false" pncs="">
                                                <img alt="安步（ANBU）轻羽筋膜枪按摩枪 蜜蜂静音大屏触控数显筋膜放松枪肌肉放松健身器材充电长续航 筋膜枪"
                                                     clstag="clickcart|keycount|xincart|cart_sku_pic"
                                                     src="//img10.360buyimg.com/cms/s80x80_jfs/t1/86006/15/14193/150573/5e620f92Eea20c1a7/4955f6b64b170bdb.jpg">
                                            </a>
                                        </div>
                                        <div class="item-msg">
                                            <div class="p-name">
                                                <a clstag="clickcart|keycount|xincart|cart_sku_name"
                                                   href="//item.jd.com/57730305717.html" target="_blank">
                                                    安步（ANBU）轻羽筋膜枪按摩枪 蜜蜂静音大屏触控数显筋膜放松枪肌肉放松健身器材充电长续航 筋膜枪
                                                </a>
                                            </div>
                            ...
                            <div class="item-extra mb10">
                                ...
                                <div class="gift-items gift-items-new">
                                    ...
                                    <%--<div class="gift-item" giftid="42030576999" num="1" fresh="" iszy="" category="1318;1463;13160">--%>
                                    <%--<a class="gift-info" href="//item.jd.com/42030576999.html" target="_blank" title="延保卡 限时赠送">--%>
                                    ...
                                    <%--<a href="//item.jd.com/42030576999.html" target="_blank" class="gift-price">查看价格</a>--%>
                                    <%--</div>--%>
                                </div>
                                <!-- 落地配服务 -->
                            </div>
                        ...
                        <div class="cart-smart-main" style="width: 1349px; height: 50px;">
                            <div class="toolbar-wrap">
                                ...
                                <div class="options-box">
                                    ...
                                    <%--</div>--%>
                                    <%--<div class="operation">--%>
                                        <%--<a href="#none" clstag="clickcart|keycount|xincart|cart_somesku_del" class="remove-batch">删除选中商品</a>--%>
                                        <%--<a href="#none" class="follow-batch" clstag="clickcart|keycount|xincart|cart_somesku_guanzhu">移到关注</a>--%>
                                    ...
                                    <div class="toolbar-right toolbar-right-new">
                                            ...
                                            <div class="comm-right">
                                                <div class="btn-area">
                                                    <a href="javascript:void(0);" onclick="return false;"
                                                       clstag="clickcart|keycount|xincart|cart_gotoOrderOut" class="jdInt-submit-btn-hd">
                                                        去海囤全球结算<b></b></a>
                                                    <a href="javascript:void(0);" onclick="return false;"
                                                       clstag="clickcart|keycount|xincart|cart_gotoOrder" class="common-submit-btn">
                                                        去京东结算<b></b></a>
                                                </div>
                                                <div class="price-sum">
                                                    <div>
										...
										<em data-bind="0.00">¥0.00</em>
                                                        ...
                                                        <br>
                                                        <div id="price-sum-extra-2" class="price-sum-extra"><span class="">促销：</span><span
                                                                class="">-¥0.00</span></div>
                                                    </div>
                                                </div>
                                                <div class="amount-sum">
